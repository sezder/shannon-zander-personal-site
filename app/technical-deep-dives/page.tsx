...
function ProjectSection({
  ...
  return (
    ...
    >
      ...
      >
        <div 
          className={`pb-4 pr-4 pl-[calc(1rem+1px)] ${text({ role: 'body', tone: 'muted' })}`}
          ...
          {skills && skills.length > 0 && (
            <div className="flex flex-wrap gap-1.5 mb-4">
              {skills.map((skill, index) => (
                <span
                  key={index}
                  className={`inline-flex items-center px-2 py-0.5 rounded-full ${text({ role: 'badge' })} bg-white dark:bg-white text-black dark:text-black border border-neutral-300 dark:border-neutral-300`}
                >
                  {skill}
                </span>
              ))}
  ...
  const projects = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <SpacerLine>
            <div>
              <h4 className={`${text({ role: 'h4' })} mb-3 mt-4`}>Conclusion</h4>
            <h5 className={`${text({ role: 'h5' })} mt-4 mb-3`}>Summary</h5>
            <p>
...
SELECT SLEEP(60);`}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div>
            <p className={`${text({ role: 'body', tone: 'muted' })} mb-4`}>
          ...
          <SpacerLine>
            <div>
              <h4 className={`${text({ role: 'h4' })} mb-3 mt-4`}>Problem</h4>
              <p>
          ...
          <SpacerLine>
            <div>
              <h4 className={`${text({ role: 'h4' })} mb-3 mt-4`}>Solution</h4>
              <p>
  ...
  interval: 80
          ...
          <SpacerLine>
            <div>
              <h4 className={`${text({ role: 'h4' })} mb-3 mt-4`}>Outcome</h4>
              <ul className="list-disc list-inside space-y-1 ml-4">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <SpacerLine>
            <div>
              <h4 className={`${text({ role: 'h4' })} mb-3 mt-4`}>Context</h4>
              <p>
